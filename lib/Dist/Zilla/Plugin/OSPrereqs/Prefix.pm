...
package Dist::Zilla::Plugin::OSPrereqs::Prefix;
...
Dist::Zilla::Plugin::OSPrereqs::Prefix - List prereqs conditional on operating system
...
Some prefixes are recognized, i.e. CE<lt>!E<gt> (not), CE<lt>~E<gt> (regex match), CE<lt>!~E<gt> (regex
...
DZP::OSPrereqs. A patchE<sol>pull request is also sent to DZP::OSPrereqs.
...
at L<https://github.com/sharyanto/operl-Dist-Zilla-Plugin-OSPrereqs/issues>.
...
L<https://github.com/sharyanto/operl-Dist-Zilla-Plugin-OSPrereqs>
